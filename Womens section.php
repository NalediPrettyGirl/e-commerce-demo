...
<?php include 'nav.php'?>
    ...
    <div class="jumbotron">
        <h4><a href="shopnow.php">Home</a>/Women</h4>
    </div>
</div>
...
<div class="container">
    ...
    <div class = "col-lg-12 col-md-12 col-sm-12 mt-5">
      <h4 class= "text-center">THAT GIRL</a></h4>
</div>
</div>
</div>
<div class="container">
...
<?php 
       $sel_sql = "SELECT * FROM women WHERE Item_id='2'";
        ...
        <div class="card text-center my-card">
            <form method="post" action="to-cart-script.php?Item_id=' . $row['Item_id'] . '">
                ...
                <p><a href="to-cart-script.php?Item_id=' . $row['Item_id'] . '"></a></p>
            </form>
        </div>
    </div>';
        }
...
<?php 
        $sel_sql = "SELECT * FROM women WHERE Item_id='12'";
        $run_sql = mysqli_query($conn, $sel_sql);
...
<?php 
$sel_sql = "SELECT * FROM women WHERE Item_id='7'";
$run_sql = mysqli_query($conn, $sel_sql);
...
<div class="container">
        <div class="row">
    <div class = "col-lg-12 col-md-12 col-sm-12 mt-5">
      <h4 class= "text-center">ON THE BLOCK</a></h4>
</div>
</div>
</div>
<?php 
$sel_sql = "SELECT * FROM women";
$run_sql = mysqli_query($conn, $sel_sql);
