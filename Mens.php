...
<head>
   ...
   padding: 10px;
    ...
    <div class="jumbotron">
        <h4><a href="shopnow.php">Home</a>/Men</h4>
    </div>
...
<div class="container">
    ...
    <div class = "col-lg-12 col-md-12 col-sm-12 mt-5">
      <h4 class= "text-center">THAT GUY</a></h4>
</div>
</div>
</div>
<div class="container">
...
<?php 
        $sel_sql = "SELECT * FROM men WHERE Item_id='1'";
...
<?php 
      ...
      ?>
<?php 
        $sel_sql = "SELECT * FROM men WHERE Item_id='12'";
        $run_sql = mysqli_query($conn, $sel_sql);
...
<div class="container">
        <div class="row">
    <div class = "col-lg-12 col-md-12 col-sm-12 mt-5">
      <h4 class= "text-center">MR.  N I C E  G U Y</a></h4>
</div>
</div>
</div>
        <?php 
