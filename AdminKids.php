...
while ($row = mysqli_fetch_assoc($run_sql)) {
    ...
    <div class="col-lg-3 col-md-6 col-sm-12 mt-5">
        ...
        <br>
        <form method="post" action="Editkids.php">
            ...
            <input type="submit" name="Edit_kids" class="btn btn-outline-warning" value="Edit"><br><br>
            <a href="AdminDelete2-script.php?delete_item_id=' . $row['Item_id'] . '" class="btn btn-outline-danger">Delete</a>
...
<div class="container my-4">
    <form method="post" action="addItemScript.php">
        ...
        <button type="submit" name="Add_kids" class="btn btn-outline-danger">Add Item</button>
    </form>
</div>
