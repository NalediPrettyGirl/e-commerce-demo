...
while ($row = mysqli_fetch_assoc($run_sql)) {
    ...
    <div class="col-lg-3 col-md-6 col-sm-12 mt-5">
        ...
        <br>
        <form method="post" action="Editwomen.php">
            ...
            <a href="AdminDelete-script.php?delete_item_id=' . $row['Item_id'] . '" class="btn btn-outline-danger">Delete</a>
...
<div class="container my-4">
    <form method="post" action="addItemScript.php">
        ...
        <button type="submit" name="add_Women" class="btn btn-outline-danger">Add Item</button>
